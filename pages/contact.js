              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+919031263531" className="text-slate-600 hover:text-rose-600 transition-colors">
                          +91 9031263531
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:homesmakeover.in@gmail.com" className="text-slate-600 hover:text-rose-600 transition-colors">
                ...
                <div className="bg-gradient-to-br from-rose-50 to-rose-100 rounded-2xl p-8">
                  ...
                  <div className="space-y-4">
                    <a 
                      href="/survey" 
                      className="block w-full px-6 py-3 bg-rose-600 hover:bg-rose-700 text-white rounded-lg font-semibold text-center transition-colors"
                    >
                      Request Free Survey
                    </a>
                    <a 
                      href="tel:+919031263531" 
                      className="block w-full px-6 py-3 border-2 border-rose-600 text-rose-600 hover:bg-rose-600 hover:text-white rounded-lg font-semibold text-center transition-colors"
                    >
                      Call Now
                    </a>
                  </div>
